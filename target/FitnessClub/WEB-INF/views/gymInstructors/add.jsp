...
<head>
    ...
    <style>
        ...
        body {
            background-image: url("../../../resources/kai.jpg");
            height: 100%;
...
<div cssClass="text-center">
    <form:form  cssClass="form-inline" modelAttribute ="gymInstructors" method="POST">
        ...
        <form:errors path="salary" element="div" cssClass="error" />
