...
<head>
    ...
    <style>
        body {
            background-image: url("../../../resources/slide-new-1.jpg");
            height: 100%;
...
<div cssClass="text-center">
    <form:form  cssClass="form-inline" modelAttribute ="gymPayroll" method="POST">
        <form:hidden path="id"/><br/>
        <%--Month:<form:input path="month"/><br/>--%>
        Month: <form:select cssClass="form-control mr-sm-2" path="month" items="${months}" /><br/>
        Gym instructors:<form:select items="${gymInstructors}" path="gymInstructors" itemValue="id" itemLabel="fullName" />
